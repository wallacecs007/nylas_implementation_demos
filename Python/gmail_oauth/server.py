#this process came from https://github.com/nylas/nylas-python/tree/main/examples/native-authentication-gmail
...
def index():
    ...
    client = APIClient(
        client_id=app.config["NYLAS_CLIENT_ID"],
        client_secret=app.config["NYLAS_CLIENT_SECRET"],
